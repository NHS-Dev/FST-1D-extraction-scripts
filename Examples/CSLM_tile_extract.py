...
lat = 53.491
lon = 261.537
ip1 = [60068832] #ip1 for inland lake 
coords = fstgetcoords(input_geophy, lat = lat, lon = lon, ip1 = ip1, threshold = 1)

#-----------------------------------------
#read and export data from geophy.fst

input_geophy = "/home/cga001/data/sitestore3/sps/experiments/SPS_5.9.9_CSLM_exp3/geophy/Gem_geophy.fst"
output_path = ''
...
#  Start date/time.
START_TIME = datetime(2016, 8, 3, tzinfo = LOCAL_TIME_ZONE)
# Stop date/time.
STOP_BEFORE_TIME = datetime(2016, 8, 5, tzinfo = LOCAL_TIME_ZONE)
